...
A cluster membership library specific for AWS. It is built on top of [aws/clock-bound](https://github.com/aws/clock-bound) (via [spindle-cb](https://github.com/flowerinthenight/spindle-cb)) therefore it requires [CGO](https://pkg.go.dev/cmd/cgo) as well. It is a port (subset only) of [hedge](https://github.com/flowerinthenight/hedge).
